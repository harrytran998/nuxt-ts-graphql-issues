    ...
    <CBox v-bind="mainStyles[colorMode]" d="flex" w="full" h="full" flex-dir="column" justify-content="center">
      ...
      <CFlex justify="center" direction="column" align="center">
        <CBox mb="3">
          ...
          <CButton right-icon="email" variant-color="cyan.400" @click="showToast"> Show Toast </CButton>
          <CButton right-icon="email" variant-color="cyan.400" @click="showToast"> Show Toast </CButton>
        </CBox>
        <CAvatarGroup>
        ...
        <CButton left-icon="close" variant-color="red" mt="3" @click="showModal = true"> Delete Account </CButton>
        <CButton left-icon="close" variant-color="red" mt="3" @click="showModal = true"> Delete Account </CButton>
        <CButton right-icon="close" variant-color="blue" mt="3" @click="showModal = true"> Delete Account </CButton>
        <CButton right-icon="close" variant-color="blue" mt="3" @click="showModal = true"> Delete Account </CButton>
